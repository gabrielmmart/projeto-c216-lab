...
@router.post("/", response_description="Adicionar tarefa")
...
@router.get("/", response_description="Listar tarefas")
...
@router.get("/{id}", response_description="Listar tarefa por id")
...
@router.put("/{id}", response_description="Atualizar tarefa")
...
@router.delete("/{id}", response_description="Deletar tarefa")
